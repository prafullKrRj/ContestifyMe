...
object GetChartData {
    ...
    fun getVerdictsList(verdicts: HashMap<String, Int>): List<PieChartData.Slice> {
        val list: List<PieChartData.Slice> = verdicts.keys.map {
            PieChartData.Slice(
                ...
                color = com.prafull.contestifyme.app.profileFeature.constants.ProfileConstants.verdictsColors[it.uppercase()]!!.first,
    ...
    private fun getTagsList(verdicts: HashMap<String, Int>): List<PieChartData.Slice> {
        val list: List<PieChartData.Slice> = verdicts.keys.map {
            PieChartData.Slice(
                value = verdicts[it]!!.toFloat(),
                color = com.prafull.contestifyme.app.profileFeature.constants.ProfileConstants.solvedByTagsColor[it.lowercase()]!!,
                label = verdicts[it].toString(),
            )
        }
        return list
