...
fun ProblemsMain(viewModel: ProblemsViewModel, navController: NavController) {
    ...
    ModalNavigationDrawer(drawerContent = {
        DrawerContent(drawerState, scope, navController = navController)
...
fun DrawerContent(drawerState: DrawerState, scope: CoroutineScope, navController: NavController) {
    ModalDrawerSheet(drawerState, modifier = Modifier.width(300.dp)) {
        Column(Modifier.verticalScroll(rememberScrollState())) {
            ...
            NavigationDrawerItem(label = {
                ...
                navController.navigate(ProblemRoutes.AcmsGuru)
            })
        }
    }
}
