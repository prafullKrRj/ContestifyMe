...
fun SubMissionCard(
    ...
    val cardColor =
        com.prafull.contestifyme.app.profileFeature.constants.ProfileConstants.verdictsColors[userSubmission.verdict.uppercase()]?.first
    val textColor =
        com.prafull.contestifyme.app.profileFeature.constants.ProfileConstants.verdictsColors[userSubmission.verdict.uppercase()]?.second
    ElevatedCard(
        modifier = Modifier
            .fillMaxWidth()
